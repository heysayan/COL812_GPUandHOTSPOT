...
#define RHO_C4	0.8					// 0.8 
#define RHO_UNDERFILL 0.03
#define	RHO_SUB	(0.5) 				// 0.5
#define RHO_SOLDER	0.06			// 0.06
#define RHO_PCB	0.333				// 0.333 
...
#define SPEC_HEAT_METAL	3.55e6	/* specfic heat of silicon in J/(m^3K) [3.55e6] -> Metal is Copper like	[1.6e6] */
